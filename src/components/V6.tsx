...
import { Model as FoodModel } from "@/models/V6/Food";
import { Model as TechModel } from "@/models/V6/Tech";
import { Model as ThucongModel } from "@/models/V6/Thucong";
import { Model as ThuysanModel } from "@/models/V6/Thuysan";
import { Model as WoodModel } from "@/models/V6/Wood";
import { Model as DetmayModel } from "@/models/V6/Detmay";
...
function V6({ empty }: { empty?: boolean }) {
...
export const V6V = React.memo(V6);

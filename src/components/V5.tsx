...
import { FoodModel } from "@/models/V5/Food";
import { TechModel } from "@/models/V5/Tech";
import { ThucongModel } from "@/models/V5/Thucong";
import { ThuysanModel } from "@/models/V5/Thuysan";
import { WoodModel } from "@/models/V5/Wood";
import { DetmayModel } from "@/models/V5/Detmay";
...
function V5({ empty }: { empty?: boolean }) {
...
export const V5V = React.memo(V5);

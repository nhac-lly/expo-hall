      ...
      <group rotation={rotation}>
        <Suspense fallback={<LoadingPlaceholder position={[-9, 0.1, -20]} />}>
          {empty ? (
            ...
            <DetmayModel position={[-9, 0.1, -20]} castShadow receiveShadow />
          )}
        </Suspense>
...
function V2({ empty }: { empty?: boolean }) {
      ...
      >
        <Physics>
          ...
          <group rotation={[0, -4.7, 0]}>
            ...
            <Suspense
              fallback={<LoadingPlaceholder position={[-8, 0.1, -1]} />}
            >
              {empty ? (
                <></>
              ) : (
            ...
            <Suspense
              fallback={<LoadingPlaceholder position={[-10, 0.1, 15]} />}
            >
              {empty ? (
                <></>
              ) : (
...
export const V2V = React.memo(V2);

...
export function LOD2({nodes,materials}) {
  return (
    <group >
      ...
      <group position={[6.342, 3.697, -2.533]} rotation={[0, -0.422, 0]} scale={0.825}>
        <mesh
          castShadow
          receiveShadow
...
export function LOD3({nodes,materials}) {
  return (
    <group >
      ...
      <group position={[-6.582, 0.267, 2.838]} rotation={[0, 1.571, 0]} scale={0.973}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[-6.582, 0.267, 0.346]} rotation={[0, 1.571, 0]} scale={0.973}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[-2.345, 0.255, 2.838]} rotation={[1.571, -1.501, 1.569]} scale={0.941}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[-2.336, 0.26, 0.464]} rotation={[1.571, -1.501, 1.569]} scale={0.941}>
        <mesh
          castShadow
          receiveShadow
...
export function LOD4({nodes,materials}) {
  return (
    <group>
      <group position={[-6.815, 1.169, 2.383]} rotation={[0, 1.571, 0]} scale={1.396}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[-2.138, 0.998, 2.607]} rotation={[3.079, -0.744, 3.047]} scale={0.928}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[-6.654, 1.315, 0.754]} rotation={[0, -0.493, 0]} scale={0.006}>
        <mesh
          castShadow
          receiveShadow
      ...
      <group position={[-2.053, 0.504, 0.336]} rotation={[1.571, -1.501, 1.569]} scale={0.006}>
        <mesh
          castShadow
          receiveShadow
...
export default function Thuysan(props) {
  const [level1,level2 , level3 , level4] = useGLTF(['/V7/THUYSAN_LOD/thuysan_L1.glb','/V7/THUYSAN_LOD/thuysan_L2.glb','/V7/THUYSAN_LOD/thuysan_L3.glb','/V7/THUYSAN_LOD/thuysan_L4.glb'])

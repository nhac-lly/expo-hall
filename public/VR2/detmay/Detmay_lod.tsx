  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-0.204, 1.224, -2.958]} scale={[3.36, 1.255, 0.006]}>
        <mesh castShadow receiveShadow geometry={nodes.Cube001.geometry} material={materials['Material.004']} />
        <mesh castShadow receiveShadow geometry={nodes.Cube001_1.geometry} material={materials['Inst_Rack_01.002']} />
        <mesh castShadow receiveShadow geometry={nodes.Cube001_2.geometry} material={materials.adskMatPhysicalMaterial_12} />
      </group>
      ...
      <mesh castShadow receiveShadow geometry={nodes._l1_BP_Banner_left_2.geometry} material={materials['Inst_Rack_01.004']} position={[4.579, 0.954, 0.183]} rotation={[0, -0.238, 0]} scale={[1.129, 1.067, 0.934]} />
      <mesh castShadow receiveShadow geometry={nodes._l1_BP_Visual_Banner_left_1.geometry} material={materials['Material.002']} position={[-5.118, 0.954, 0.214]} rotation={[0, 0.23, 0]} scale={[1.129, 1.067, 0.934]} />
      <mesh castShadow receiveShadow geometry={nodes._l1_BP_Visual_Banner_left_2.geometry} material={materials['Material.001']} position={[4.579, 0.954, 0.183]} rotation={[0, -0.238, 0]} scale={[1.129, 1.067, 0.934]} />
      <group position={[-4.823, 1.601, 2.115]} rotation={[-Math.PI / 2, 0, 1.76]} scale={[0.002, 0.001, 0.001]}>
        <mesh castShadow receiveShadow geometry={nodes.Box100007.geometry} material={materials['Green Lizerd']} />
        <mesh castShadow receiveShadow geometry={nodes.Box100007_1.geometry} material={materials['Fast Gold']} />
      </group>
      ...
      <mesh castShadow receiveShadow geometry={nodes._l3_Men_mannequin001.geometry} material={nodes._l3_Men_mannequin001.material} position={[2.225, -0.042, 1.234]} rotation={[Math.PI, -0.987, Math.PI]} scale={0.152} />
      <mesh castShadow receiveShadow geometry={nodes._l3_Men_mannequin002.geometry} material={materials['Material.009']} position={[2.225, -0.042, 1.234]} rotation={[Math.PI, -0.987, Math.PI]} scale={0.152} />
      <mesh castShadow receiveShadow geometry={nodes._l3_Men_mannequin003.geometry} material={nodes._l3_Men_mannequin003.material} position={[2.225, -0.042, 1.234]} rotation={[Math.PI, -0.987, Math.PI]} scale={0.152} />
      <mesh castShadow receiveShadow geometry={nodes._l3_Men_mannequin004.geometry} material={materials['Material.005']} position={[2.225, -0.042, 1.234]} rotation={[Math.PI, -0.987, Math.PI]} scale={0.152} />
      <mesh castShadow receiveShadow geometry={nodes._l3_Men_mannequin005.geometry} material={materials['Material.011']} position={[2.627, 2.055, 1.531]} rotation={[Math.PI, -0.987, Math.PI]} scale={0.152} />
      <mesh castShadow receiveShadow geometry={nodes._l3_Shoes_box.geometry} material={materials.adskMatPhysicalMaterial_1} position={[-5.819, 0.554, 2.436]} rotation={[-Math.PI / 2, 0, 0.171]} scale={[0.002, 0.001, 0.001]} />
      <group position={[-6.109, 0.248, 3.491]} rotation={[-1.383, 0.02, -1.118]} scale={[0.043, 0.043, 0.052]}>
        <mesh castShadow receiveShadow geometry={nodes.vm_v2_054.geometry} material={materials['adskMatPhysicalMaterial_10.002']} />
        <mesh castShadow receiveShadow geometry={nodes.vm_v2_054_1.geometry} material={materials['adskMatPhysicalMaterial_6.001']} />
        <mesh castShadow receiveShadow geometry={nodes.vm_v2_054_2.geometry} material={materials['adskMatPhysicalMaterial_9.001']} />
      </group>
      <group position={[-3.461, 2.081, 0.825]} rotation={[-Math.PI / 2, 0, 1.916]} scale={[0.002, 0.001, 0.001]}>
        <mesh castShadow receiveShadow geometry={nodes.Box100010.geometry} material={materials.adskMatPhysicalMaterial_14} />
        <mesh castShadow receiveShadow geometry={nodes.Box100010_1.geometry} material={materials.adskMatPhysicalMaterial_12} />
      </group>
      <group position={[-3.681, 1.067, 2.179]} rotation={[-Math.PI / 2, 0, 0.688]} scale={[0.002, 0.001, 0.001]}>
        <mesh castShadow receiveShadow geometry={nodes.Box100012.geometry} material={materials.adskMatPhysicalMaterial_7} />
        <mesh castShadow receiveShadow geometry={nodes.Box100012_1.geometry} material={materials['adskMatPhysicalMaterial_10.001']} />
        <mesh castShadow receiveShadow geometry={nodes.Box100012_2.geometry} material={materials.adskMatPhysicalMaterial_6} />
      </group>
      <mesh castShadow receiveShadow geometry={nodes._l3_Women_mannequin_box.geometry} material={materials['adskMatPhysicalMaterial_1.001']} position={[-3.494, 0.169, 0.903]} rotation={[-Math.PI / 2, 0, 0.291]} scale={[0.002, 0.001, 0.001]} />
      <mesh castShadow receiveShadow geometry={nodes._l3_Women_mannequin_box001.geometry} material={materials.adskMatPhysicalMaterial_1} position={[-4.771, 0.687, 2.214]} rotation={[-Math.PI / 2, 0, 1.76]} scale={[0.002, 0.001, 0.001]} />
      <mesh castShadow receiveShadow geometry={nodes._l3_Women_mannequin_box002.geometry} material={materials.adskMatPhysicalMaterial_1} position={[-3.736, 0.28, 1.831]} rotation={[-Math.PI / 2, 0, -0.349]} scale={[0.002, 0.001, 0.001]} />
